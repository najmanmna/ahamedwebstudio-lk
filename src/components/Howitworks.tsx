...
// ─── STEP CARD ────────────────────────────────────────────────────────────────
function StepCard({ step, index, active, onClick, entered, paused }: { step: Step; index: number; active: number; onClick: (i: number) => void; entered: boolean; paused: boolean }) {
  ...
  return (
    ...
    >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
            <span style={{
              ...
              color: isActive ? step.color : "#4E4E4B",
              textTransform: "uppercase",
              transition: "color 0.3s",
            }}>{step.day}</span>
            <span style={{
              fontFamily: "var(--font-mono)",
              fontSize: 11, color: "#E5E3DD",
            }}>·</span>
            <span style={{
              fontFamily: "var(--font-mono)",
      ...
      {/* Progress bar — only on active card, restarts on each activation */}
      {isActive && (
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 2, background: step.color + "18" }}>
          <div
      ...
      <div style={{ padding: "32px 32px 36px" }}>
        ...
        {step.number === "04" && (
          <a
            ...
            style={{ marginTop: 24, display: "inline-flex", padding: "12px 22px", fontSize: 13, letterSpacing: "0.12em" }}
          >
...
export default function HowItWorks() {
  ...
  const handleMouseLeave = useCallback(() => {
    clearTimeout(resumeTimerRef.current);
    resumeTimerRef.current = setTimeout(() => setPaused(false), 800);
  }, []);
  ...
  return (
    ...
    >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 16 }}>
            ...
            <div>
              <p style={{
                ...
                color: "#4E4E4B", lineHeight: 1.75, maxWidth: 300,
                marginBottom: 14,
              }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <div style={{
                  ...
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.12em", color: "#1A2848", textTransform: "uppercase" }}>
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.12em", color: "#F25C43", textTransform: "uppercase" }}>
                    E-Commerce — 14 days
                  </span>
                </div>
              </div>
      ...
      <style>{`
        ...
        @keyframes processProgressGrow { from { width: 0%; } to { width: 100%; } }
        .process-progress-bar { animation: processProgressGrow 4s linear forwards; }
